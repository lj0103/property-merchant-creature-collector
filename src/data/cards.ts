...
const names: Record<EnergyType, string[]> = {
  flame: ['火绒狐','烬尾雀','熔岩团子','暖灯貂','赤角兽','曜焰狮','曦火凰'],
  aqua: ['潮泡龟','雾鳍鱼','涟漪獭','月湾鳐','沧澜鲸','镜海蛟','霁雨鲲'],
  leaf: ['苔绒鹿','芽冠兔','藤铃猫','苍木熊','森语蝶','古枝猿','翠穹鹿'],
  spark: ['雷纹鹿','电芽鼬','闪翎雀','霆角羊','流光貂','云暴鹰','天鼓兽'],
  mind: ['梦砂狸','星瞳鸮','幻泡貘','念晶狐','星眠龙','时隙鲸','秘辉龙'],
};
const flavor: Record<EnergyType, string> = { flame:'在余烬旁留下温暖足迹。',aqua:'把清凉水汽藏进鳞片。',leaf:'能听见种子萌芽的声音。',spark:'奔跑时空气发出轻响。',mind:'总在梦境边缘安静守望。' };
...
const counts: Record<Level, number> = {1:15,2:10,3:8};

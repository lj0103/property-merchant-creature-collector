...
export function GameRulesDialog({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <>
      ...
      {open && <div className="rules-modal" role="dialog" aria-modal="true" aria-labelledby="rules-title" onMouseDown={(event) => event.target === event.currentTarget && setOpen(false)}>
